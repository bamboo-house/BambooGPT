...
export const Top = () => {
  ...
  return (
    <div className="top-main flex h-screen w-full overflow-y-auto overflow-x-hidden">
      <div className="top-leftsidebar h-full w-64 flex-none ">
        <div className="fixed left-0 top-0 h-full w-64 bg-gpt-dark">LeftSidebar</div>
      </div>

      <div className="top-body w-full">
        <div className="top-topbar fixed left-64 right-0 top-0 h-8 border border-gpt-dark border-b-zinc-500 bg-gpt-dark">
        ...
        <div className="top-content flex h-full w-full">
          <div className="top-chatlog mt-8">
