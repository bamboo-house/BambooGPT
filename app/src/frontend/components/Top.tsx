  ...
  return (
    <div className="top-main flex h-screen w-full overflow-y-auto overflow-x-hidden">
      ...
      <div className="top-body w-full">
        <div className="fixed left-64 right-0 top-0 h-full">
        ...
        <div className="top-content flex h-full w-full">
          ...
          <div className="fixed right-0 top-8 h-full">
            {/* 下記、RigtSidebarコンポーネントにできる  */}
            <div
              className={`h-full w-64 border border-gpt-dark border-l-zinc-500 bg-gpt-gray  ${
                showRightSidebar
