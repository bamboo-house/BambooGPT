  ...
  return (
    <div className="top-main flex h-screen w-full overflow-y-auto overflow-x-hidden">
      <div className="h-full w-64 flex-none md:w-0">
        <div className="md:-0 fixed left-0 top-0 h-full">
          {/* 下記、LeftSidebarコンポーネントにできる */}
          <div className="top-leftbar h-full w-64 bg-gpt-dark md:hidden">LeftSidebar</div>
        </div>
      </div>

      <div className="top-body relative w-full">
